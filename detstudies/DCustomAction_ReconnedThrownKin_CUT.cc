// $Id$
//
//    File: DCustomAction_ReconnedThrownKin_CUT.cc
...
void DCustomAction_ReconnedThrownKin_CUT::Initialize(JEventLoop* locEventLoop)
{
...
bool DCustomAction_ReconnedThrownKin_CUT::Perform_Action(JEventLoop* locEventLoop, const DParticleCombo* locParticleCombo)
{
	...
	for(size_t loc_i = 0; loc_i < locMCThrowns.size(); ++loc_i)
	{
		...
		if(ParticleCharge(locPID) != 0)
		{
			...
			// PID FOM cut!!!
			if(locChargedTrackHypothesis->dFOM < 6.e-7) //2.7e-3)
				continue;
